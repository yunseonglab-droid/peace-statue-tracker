...
- Street view: entry 34 opens Kakao roadview at the source coordinate. Other entries open a place search; visitors choose the result and roadview. Coverage and current location are not independently verified.
- Itinerary order is user chosen; segment directions use Google Maps transit. No automatic shortest-path or in-app driving distance claims.
